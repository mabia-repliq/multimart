  ...
  return (
    <div className="bg-white h-full w-full border hover:drop-shadow-xl rounded-lg lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between align-center leading-normal gap-4">
      ...
      <div className="flex justify-left gap-3">
        <Link href="">
          <button
            className="flex flex-row bg-teal-700 md:px-2 md:py-1 lg:px-3 lg:py-2 hover:bg-teal-900 text-white font-bold rounded bottom-2 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-110"
            type="submit"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
